...
from jupyter_o2.config_manager import generate_config_file, CFG_FILENAME, ConfigManager, JO2_DEFAULTS, \
...
class TestConfigManager:
    ...
    def test_load_config_file(self, tmpdir, monkeypatch):
        ...
        monkeypatch.chdir(tmpdir)  # Temporarily change working dir, will change back after test
        ...
        assert config.get("Defaults",
                          "DEFAULT_USER") == "mock", f"Config file {tmpdir / CFG_FILENAME} not read in correctly"
